		jQuery(document).ready(function ($) {			//Check if user is logged in. If so, let them save.
			$uid = $("#userid").val();			if ($uid > 0) {
			...
			$("#changetime").click(function() {
				var dte = '?themonth=' + $("#month").val() + '&monthname=' + $('#month option:selected').html() + '&theyear=' + $("#year").val() + '&thetab=tab1';
				var url = "/you/" + dte;
				window.location = url;			
			});	

			$("#changetime2").click(function() {
				var dte = '?themonth=' + $("#month2").val() + '&monthname=' + $('#month2 option:selected').html() + '&theyear=' + $("#year2").val() + '&thetab=tab2';
				var url = "/you/" + dte;
				window.location = url;			
			});				
