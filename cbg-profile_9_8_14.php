...
?>       
		...
		<table class="tooltable">
			...
			<tr>
				<td style="background-color:#e0e0e0;font-size:10pt;">
					<img src="http://www.change-based-giving.org/cbg/wp-content/uploads/2014/05/light.png" alt="Lighting" width="40" style="vertical-align:middle;" />&nbsp;&nbsp;&nbsp;<strong>Lighting</strong>
				</td>
				<td class="dollarcell">
					<?php echo getSavings('lighting','M'); ?>
				</td>
				<td class="dollarcell">
					<?php echo getSavings('lighting','Y'); ?>
				</td>
			</tr>
			<tr>
				<td style="background-color:#e0e0e0;font-size:10pt;">
...
?>       
		...
		<table class="tooltable">
			...
			<tr>
				...
				<td class="dollarcell">
					<?php echo getResourceSavings('cooling-2','M') . " kwh"; ?>
				</td>
				<td class="dollarcell">
					<?php echo getResourceSavings('cooling-2','Y') . " kwh"; ?>
				</td>
			</tr>
			<tr>
				<td style="background-color:#e0e0e0;font-size:10pt;">
				...
				<td class="dollarcell">
					<?php echo getResourceSavings('heating-2','M') . " kwh"; ?>
				</td>
				<td class="dollarcell">
					<?php echo getResourceSavings('heating-2','Y') . " kwh"; ?>
				</td>
			</tr>
			<tr>
				<td style="background-color:#e0e0e0;font-size:10pt;">
				...
				<td class="dollarcell">
					<?php echo getResourceSavings('lighting-2','M') . " kwh"; ?>
				</td>
				<td class="dollarcell">
					<?php echo getResourceSavings('lighting-2','Y') . " kwh"; ?>
				</td>
			</tr>
			<tr>
				<td style="background-color:#e0e0e0;font-size:10pt;">
