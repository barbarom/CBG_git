...
<div id="tabs3">
  <ul>
	...
	<div id="tabs-5">	
			<p class="inputs"><strong>What is your average utility bill during the summer months?</strong> $<input type="text" id="cooling_4" value="<?php echo $B4 ?>" style="width:50px;" /><span class="errmsg" id="errmsg4"></span><br />
			<a href="#" id="click4">[Help: How do I calculate this?]</a><div id="help4" style="display:none;">Look at your statements from last year's warmest months (when you were likely using air conditioning); add the totals together and divide by the number of months under consideration.</div>
...
<div id="tabs4">
  <ul>
	...
	<p class="inputs"><strong>What is your average utility bill for heating during the winter months?</strong> $<input type="text" id="heating_4" value="<?php echo $B4 ?>" style="width:50px;" /><span class="errmsg" id="errmsg4"></span><br />
			<a href="#" id="click4">[Help: How do I calculate this?]</a><div id="help4" style="display:none;">Look at your statements from last year's coolest months (when you were likely using heat); add the totals together and divide by the number of months under consideration.</div></p>
